...
namespace Nuclear.Channels.InvokerServices.Contracts
{
    ...
    public interface IChannelMethodRequestActivator
    {
        ...
        void PostActivate(Type channel, MethodInfo method, List<object> channelRequestBody, HttpListenerResponse response);
        ...
        /// <param name="channelRequestBody">List of parameters to be initialized</param>
        /// <param name="response">HttpListenerResponse to be written to the client</param>
        void GetActivateWithParameters(Type channel, MethodInfo method, List<object> channelRequestBody, HttpListenerResponse response);
